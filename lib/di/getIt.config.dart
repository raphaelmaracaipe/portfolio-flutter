...
import 'package:portfolio_flutter/modules/core/core_module.dart' as _i33;
...
import 'package:portfolio_flutter/modules/core/data/sp/route_sp.dart' as _i25;
import 'package:portfolio_flutter/modules/core/data/user_repository.dart'
    as _i30;
import 'package:portfolio_flutter/modules/core/localizations/app_localization.dart'
    as _i3;
import 'package:portfolio_flutter/modules/core/regex/regex.dart' as _i21;
...
import 'package:portfolio_flutter/modules/core/utils/strings.dart' as _i27;
import 'package:portfolio_flutter/modules/core/widgets/bottomsheet/bottom_sheet.dart'
    as _i6;
import 'package:portfolio_flutter/modules/core/widgets/loading/loading.dart'
    as _i20;
import 'package:portfolio_flutter/modules/uiauth/bloc/uiauth_bloc.dart' as _i31;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i21.Regex>(() => coreModule.regex);
    gh.lazySingleton<_i22.RestHandShake>(() => coreModule.restHandShake);
    gh.lazySingleton<_i23.RestUser>(() => coreModule.restUser);
    gh.lazySingleton<_i24.RouteRepository>(() => coreModule.routeRepository);
    gh.lazySingleton<_i25.RouteSP>(() => coreModule.routeSP);
    gh.lazySingletonAsync<_i26.SharedPreferences>(
        () => coreModule.sharedPreferences);
    gh.lazySingleton<_i27.Strings>(() => coreModule.strings);
    gh.factory<_i28.UICountryBloc>(() =>
        _i28.UICountryBloc(countriesRepository: gh<_i9.CountriesRepository>()));
    gh.factory<_i29.UiSplashBloc>(() => _i29.UiSplashBloc(
          key: gh<_i19.Keys>(),
          routeRepository: gh<_i24.RouteRepository>(),
          handShakeRepository: gh<_i16.HandShakeRepository>(),
        ));
    gh.lazySingleton<_i30.UserRepository>(() => coreModule.userRepository);
    gh.factory<_i31.UiAuthBloc>(() => _i31.UiAuthBloc(
          countriesRepository: gh<_i9.CountriesRepository>(),
          userRepository: gh<_i30.UserRepository>(),
          routeRepository: gh<_i24.RouteRepository>(),
        ));
    gh.factory<_i32.UiValidCodeBloc>(() => _i32.UiValidCodeBloc(
          userRepository: gh<_i30.UserRepository>(),
          routeRepository: gh<_i24.RouteRepository>(),
        ));
    return this;
