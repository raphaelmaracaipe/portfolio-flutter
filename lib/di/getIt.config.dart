...
import 'package:portfolio_flutter/modules/core/core_module.dart' as _i39;
...
import 'package:portfolio_flutter/modules/core/data/sp/route_sp.dart' as _i28;
import 'package:portfolio_flutter/modules/core/data/sp/token_sp.dart' as _i32;
...
import 'package:portfolio_flutter/modules/core/utils/strings.dart' as _i30;
import 'package:portfolio_flutter/modules/core/widgets/bottomsheet/bottom_sheet.dart'
    as _i6;
import 'package:portfolio_flutter/modules/core/widgets/loading/loading.dart'
    as _i20;
import 'package:portfolio_flutter/modules/uiauth/bloc/uiauth_bloc.dart' as _i37;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i25.RestToken>(() => coreModule.restTokenInterceptor);
    gh.lazySingleton<_i26.RestUser>(() => coreModule.restUser);
    gh.lazySingleton<_i27.RouteRepository>(() => coreModule.routeRepository);
    gh.lazySingleton<_i28.RouteSP>(() => coreModule.routeSP);
    gh.lazySingletonAsync<_i29.SharedPreferences>(
        () => coreModule.sharedPreferences);
    gh.lazySingleton<_i30.Strings>(() => coreModule.strings);
    gh.lazySingleton<_i31.TokenInterceptorRepository>(
        () => coreModule.tokenInterceptorRepository);
    gh.lazySingleton<_i32.TokenSP>(() => coreModule.tokenSP);
    gh.factory<_i33.UICountryBloc>(() =>
        _i33.UICountryBloc(countriesRepository: gh<_i9.CountriesRepository>()));
    gh.factory<_i34.UiProfileBloc>(() => _i34.UiProfileBloc(
          profileRepository: gh<_i21.ProfileRepository>(),
          routeRepository: gh<_i27.RouteRepository>(),
        ));
    gh.factory<_i35.UiSplashBloc>(() => _i35.UiSplashBloc(
          key: gh<_i19.Keys>(),
          routeRepository: gh<_i27.RouteRepository>(),
          handShakeRepository: gh<_i16.HandShakeRepository>(),
        ));
    gh.lazySingleton<_i36.UserRepository>(() => coreModule.userRepository);
    gh.factory<_i37.UiAuthBloc>(() => _i37.UiAuthBloc(
          countriesRepository: gh<_i9.CountriesRepository>(),
          userRepository: gh<_i36.UserRepository>(),
          routeRepository: gh<_i27.RouteRepository>(),
        ));
    gh.factory<_i38.UiValidCodeBloc>(() => _i38.UiValidCodeBloc(
          userRepository: gh<_i36.UserRepository>(),
          routeRepository: gh<_i27.RouteRepository>(),
        ));
    return this;
